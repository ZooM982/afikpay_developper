...
const MerchantPricing = () => {
 ...
 Des tarifs clairs pour <span className=" bg-clip-text text-transparent">votre croissance</span>
 </h1>
 ...
 {PLANS.map((plan, i) => (
 <div key={i} className={`relative flex flex-col p-8 rounded-md bg-white dark:bg-secondary-900 border-2 ${plan.color} hover: hover:-translate-y-1 transition-all duration-300`}>
 {plan.badge && (
 <span className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 bg-primary-500 text-white text-xs font-black rounded-full whitespace-nowrap">{plan.badge}</span>
 )}
 ...
 <Link to="/register"
 className={`w-full text-center py-4 rounded-md font-black text-sm transition-all ${plan.badge ? "bg-primary-500 hover:bg-primary-400 text-white " : "bg-slate-100 dark:bg-secondary-800 hover:bg-slate-200 dark:hover:bg-secondary-700 text-slate-900 dark:text-white"}`}>
 {plan.cta}
 </Link>
 </div>
 ))}
 ...
 <div>
 <div className="w-12 h-12 bg-white/10 rounded-md flex items-center justify-center mb-6 mx-auto md:mx-0"><Shield className="w-6 h-6 text-primary-400" /></div>
 ...
 <div>
 <div className="w-12 h-12 bg-white/10 rounded-md flex items-center justify-center mb-6 mx-auto md:mx-0"><Zap className="w-6 h-6 text-primary-400" /></div>
 ...
 <div>
 <div className="w-12 h-12 bg-white/10 rounded-md flex items-center justify-center mb-6 mx-auto md:mx-0"><Globe className="w-6 h-6 text-primary-400" /></div>
 ...
 <div className="mt-20 p-8 rounded-md bg-white/5 border border-white/10 text-center">
 ...
 <Link to="/contact" className="inline-flex items-center gap-2 px-8 py-4 bg-white text-slate-900 font-black rounded-md hover:bg-slate-100 transition-all">
