    ...
    <div className="space-y-6">
      {justCreated && (
        <div className="p-5 rounded-2xl bg-amber-50 dark:bg-amber-900/20 border-2 border-amber-400 dark:border-amber-600 animate-scale-in">
          ...
          <div className="flex items-center gap-2 bg-white dark:bg-amber-950/50 p-2 rounded-xl border border-amber-200 dark:border-amber-800">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        <div className="xl:col-span-2 space-y-4">
          {activeKeys.map((k) => (
            <div key={k._id} className="p-6 bg-white dark:bg-secondary-900 rounded-3xl border border-slate-100 dark:border-secondary-800 shadow-sm group hover:border-primary-500/50 transition-all">
              ...
              <div className="flex items-center gap-2 bg-slate-50 dark:bg-secondary-800 p-3 rounded-xl border border-slate-100 dark:border-secondary-700 mb-4">
        ...
        <div className="space-y-6 sticky top-24">
          <div className="bg-white dark:bg-secondary-900 p-8 rounded-3xl border border-slate-100 dark:border-secondary-800 shadow-sm">
            ...
            <form onSubmit={async (e) => {
              ...
              <div>
                <input name="testKey" placeholder="sk_live_..." defaultValue={justCreated || ""} required
                  className="w-full px-4 py-3 rounded-xl bg-slate-800 border border-slate-700 text-white text-sm font-mono focus:border-emerald-500 outline-none" />
              </div>
              <button type="submit" disabled={loadingTest}
                className="w-full py-4 px-2 bg-emerald-500 hover:bg-emerald-400 disabled:opacity-50 text-slate-900 font-black rounded-2xl transition-all shadow-lg shadow-emerald-500/20 flex flex-col sm:flex-row items-center justify-center gap-2">
