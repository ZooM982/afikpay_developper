...
const Transactions = () => {
 ...
 if (loading) return (
 <div className="bg-white dark:bg-secondary-900 rounded-md border border-slate-100 dark:border-secondary-800 overflow-hidden animate-pulse">
 ...
 <input type="text" placeholder="Rechercher..." className="pl-10 pr-4 py-2 bg-white dark:bg-secondary-900 border border-slate-200 dark:border-secondary-800 rounded-md text-sm font-medium outline-none focus:border-primary-500" />
 </div>
 <button className="p-2 bg-white dark:bg-secondary-900 border border-slate-200 dark:border-secondary-800 rounded-md text-slate-500"><Filter className="w-4 h-4" /></button>
 </div>
 </div>

 <div className="bg-white dark:bg-secondary-900 rounded-md border border-slate-100 dark:border-secondary-800 overflow-hidden ">
