...
const Countries = () => {
 ...
 {[1,2,3,4,5,6].map(i => <div key={i} className="h-64 bg-slate-100 dark:bg-secondary-900 rounded-md" />)}
 </div>
 );
 ...
 className="px-6 py-3 bg-primary-500 hover:bg-primary-400 text-white font-black rounded-md transition-all flex items-center gap-2 text-sm disabled:opacity-50">
 ...
 <div key={c.code} className="p-6 bg-white dark:bg-secondary-900 rounded-md border border-slate-100 dark:border-secondary-800 flex flex-col justify-between">
 <div>
 ...
 <div key={op.name} className="flex items-center justify-between p-2 rounded-md bg-slate-50 dark:bg-secondary-800 border border-slate-100 dark:border-secondary-700">
