...
const Webhooks = () => {
 ...
 <div className="p-8 rounded-md bg-white dark:bg-secondary-900 border border-slate-100 dark:border-secondary-800 ">
 <div className="flex items-center gap-4 mb-8">
 <div className="w-12 h-12 bg-violet-100 dark:bg-violet-900/30 text-violet-600 rounded-md flex items-center justify-center">
 ...
 className="flex-1 px-4 py-3.5 rounded-md bg-slate-50 dark:bg-secondary-800 border border-slate-200 dark:border-secondary-700 text-sm font-medium outline-none focus:border-primary-500"
 />
 <button 
 onClick={updateWebhook}
 disabled={updating}
 className="px-8 py-3.5 bg-primary-500 hover:bg-primary-400 text-white font-black rounded-md transition-all disabled:opacity-50"
 >
 ...
 <div className="p-6 rounded-md bg-amber-50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-900/30">
 ...
 <code className="flex-1 px-4 py-3 bg-white/50 dark:bg-black/20 text-amber-900 dark:text-amber-100 rounded-md text-xs font-mono border border-amber-200/50 dark:border-amber-800/20 break-all">
 {stats?.webhookSecret || "••••••••••••••••••••••••••••••••"}
 </code>
 <button onClick={copySecret} className="p-3 bg-amber-500 hover:bg-amber-400 text-white rounded-md transition-all ">
 ...
 <div key={ev.event} className="flex items-center gap-4 p-4 rounded-md hover:bg-slate-50 dark:hover:bg-secondary-800/50 transition-colors">
