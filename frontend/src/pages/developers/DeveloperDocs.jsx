...
const CodeBlock = ({ code, id }) => {
 ...
 return (
 <div className="relative rounded-md bg-slate-950 border border-slate-800 overflow-hidden">
...
const DeveloperDocs = () => {
 ...
 <div className="p-5 rounded-md bg-primary-50 dark:bg-primary-900/10 border border-primary-100 dark:border-primary-900/30 mb-6">
 ...
 <div key={s.label} className="p-4 rounded-md bg-slate-50 dark:bg-secondary-900/50 border border-slate-100 dark:border-secondary-800 text-center">
 ...
 <span className={`${ep.color} text-white text-xs font-black px-2.5 py-1 rounded font-mono`}>{ep.method}</span>
 ...
 <div key={country.code} className="rounded-md border border-slate-100 dark:border-secondary-800 overflow-hidden">
 <button
 ...
 <div key={ev.event} className="flex items-center gap-4 p-4 rounded-md bg-slate-50 dark:bg-secondary-900/50 border border-slate-100 dark:border-secondary-800">
 <code className="text-xs bg-primary-100 dark:bg-primary-900/30 text-primary-700 dark:text-primary-400 px-2.5 py-1 rounded font-mono shrink-0">{ev.event}</code>
 ...
 <div className="mt-8 p-5 rounded-md bg-slate-50 dark:bg-secondary-900/50 border border-slate-100 dark:border-secondary-800">
