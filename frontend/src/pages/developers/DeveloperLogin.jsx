			...
			<div className="w-full max-w-md">
				...
				<form onSubmit={handleSubmit} className="bg-slate-800/50 border border-slate-700/50 rounded-md p-8 space-y-5 backdrop-blur-sm">
					...
					<button type="submit" disabled={loading}
						className="w-full py-4 bg-primary-500 hover:bg-primary-400 disabled:opacity-60 text-white font-black rounded-md transition-all hover:-translate-y-0.5 flex items-center justify-center gap-3 text-lg mt-2">
						{loading
