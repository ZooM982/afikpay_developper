...
const CheckoutPage = () => {
 ...
 return (
 <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex items-center justify-center p-4">
 <div className="bg-white dark:bg-secondary-900 p-8 rounded-md max-w-md w-full text-center">
 ...
 {/* Checkout Box */}
 <div className="w-full max-w-md bg-white dark:bg-secondary-900 rounded-[2rem] overflow-hidden">
 ...
 {payError && (
 <div className="p-4 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 text-sm font-bold rounded-md text-center">
 {payError}
 </div>
 )}
 ...
 className="w-full px-4 py-4 rounded-md bg-slate-50 dark:bg-secondary-800 border border-slate-200 dark:border-secondary-700 text-sm font-bold text-slate-900 dark:text-white focus:border-primary-500 outline-none transition-colors appearance-none"
 >
 ...
 className={`py-3 rounded-md text-xs font-black transition-all border-2 ${operator === opId ? 'border-primary-500 bg-primary-50 dark:bg-primary-900/20 text-primary-600 dark:text-primary-400' : 'border-slate-100 dark:border-secondary-800 text-slate-500 hover:border-slate-200'}`}
 >
 {op.name}
 </button>
 )
 ...
 required
 className="w-full pl-12 pr-4 py-4 rounded-md bg-slate-50 dark:bg-secondary-800 border border-slate-200 dark:border-secondary-700 text-sm font-bold text-slate-900 dark:text-white focus:border-primary-500 outline-none transition-colors" 
 />
 </div>
 </div>
 ...
 className="w-full py-4 bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-black rounded-md hover:opacity-90 transition-all dark:shadow-white/10 disabled:opacity-50 flex items-center justify-center gap-2 mt-4"
 >
