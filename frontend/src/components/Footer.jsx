...
const Footer = () => {
 ...
 {[
    { icon: Github, href: "https://github.com/afrikpay" },
    { icon: Twitter, href: "https://twitter.com/afrikpay" },
    { icon: Linkedin, href: "https://linkedin.com/company/afrikpay" },
    { icon: Mail, href: "mailto:contact@afrikpay.tech" }
 ].map(({ icon: Icon, href }, i) => (
 <a key={i} href={href} target="_blank" rel="noopener noreferrer" className="p-2 rounded bg-slate-50 dark:bg-secondary-900 text-slate-400 hover:text-primary-500 hover:bg-primary-50 dark:hover:bg-primary-500/10 transition-all">
