        ...
        <header className="h-16 bg-white dark:bg-secondary-900 border-b border-slate-200 dark:border-secondary-800 flex items-center justify-between px-6 shrink-0 z-40">
          ...
          <div className="flex items-center gap-4">
            <div className="relative" ref={notifRef}>
              <button 
                onClick={toggleNotif}
                className="p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-secondary-800 text-slate-400 relative transition-colors focus:outline-none"
              >
                <Bell size={20} />
                {unreadCount > 0 && (
              ...
              {isNotifOpen && (
                <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-secondary-900 rounded-2xl shadow-xl border border-slate-100 dark:border-secondary-800 z-50 overflow-hidden flex flex-col">
