...
const DashboardLayout = ({ children, type = 'client' }) => {
 ...
 {isNotifOpen && (
 <div className="absolute right-0 mt-2 w-[300px] sm:w-80 bg-white dark:bg-secondary-900 rounded-md border border-slate-100 dark:border-secondary-800 z-50 overflow-hidden flex flex-col">
